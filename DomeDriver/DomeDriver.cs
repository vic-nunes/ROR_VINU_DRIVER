//
// ASCOM Dome driver for ROR_VINU
//
// Description:	 Ascom Driver for Roll off Roof. To be used with Arduino VINU Connector
//
// Implements:	ASCOM Dome interface version: 1.0
// Author:		Vitor Nunes <vitormanuelnunes@gmail.com>
//
...
namespace ASCOM.ROR_VINU.Dome
{
    ...
    //
    // Your driver's DeviceID is ASCOM.ROR_VINU.Dome
    //
    // The COM Guid attribute sets the CLSID for ASCOM.ROR_VINU.Dome
    // The COM ClassInterface/None attribute prevents an empty interface called _ROR_VINU from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("b3c8f57a-12b4-4f6c-b749-569f1beb7739")]
    [ProgId("ASCOM.ROR_VINU.Dome")]
    [ServedClassName("Roll-off Roof Arduino Connector")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Dome : ReferenceCountedObjectBase, IDomeV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ROR_VINU"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Dome()
        {
            try
            {
                ...
                tl = new TraceLogger("", "ROR_VINU.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.ROR_VINU.Dome", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
